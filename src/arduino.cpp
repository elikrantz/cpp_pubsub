...
//    // std::string serial_device = "/dev/ttyACMrclcpp0";
//    std::string serial_device = "/dev/serial/by-path/pci-0000:00:14.0-usb-0:3:1.0"; // usb 3 top
