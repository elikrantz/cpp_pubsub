...
def generate_launch_description():
    ...
    pointCloutFrameId = LaunchConfiguration('integratedFrameId', default="odom")
    
    #parameter for the first laserscan, feel free to duplicate and rename for other laserscans
    scanTopic1 = LaunchConfiguration('scanTopic1', default="sensorData/lidarData")
    ...
    scanTopic2 = LaunchConfiguration('scanTopic2', default="sensorData/depthCamData")
    ...
    robotFrontEnd = LaunchConfiguration('robotFrontEnd', default=0.0)
    robotRearEnd = LaunchConfiguration('robotRearEnd', default=0.0)
    robotRightEnd = LaunchConfiguration('robotRightEnd', default=0.0)
    robotLeftEnd = LaunchConfiguration('robotLeftEnd', default=0.0)
