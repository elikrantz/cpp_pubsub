...
public:
    goalHandler() : Node("goalHandle") {
        ...
        looping_thread_ = std::thread(&goalHandler::worker_thread, this);
...
private:
    void testingReading(const geometry_msgs::msg::PoseStamped::SharedPtr msg) const {
    ...
    bool checkIfAtGoal() {
        ...
        RCLCPP_INFO(this->get_logger(), "Goal Status: %d", arrivedAtGoal);
